...
df_artisti['yearOfBirth'] = pd.to_numeric(df_artisti['yearOfBirth'].fillna(pd.NA), downcast='integer')
df_artisti['yearOfDeath'] = pd.to_numeric(df_artisti['yearOfDeath'].fillna(pd.NA), downcast='integer')
...
df_lavori['acquisitionYear'] = pd.to_numeric(df_lavori['acquisitionYear'].fillna(pd.NA), downcast='integer')
