...
df_artisti['id'] = pd.to_numeric(df_artisti['id'], errors='coerce')
df_artisti['name'] = df_artisti['name']
df_artisti['gender'] = df_artisti['gender']
...
df_artisti['placeOfBirth'] = df_artisti['placeOfBirth']
df_artisti['placeOfDeath'] = df_artisti['placeOfDeath']
df_artisti['url'] = df_artisti['url']
...
df_lavori['dimensions'] = df_lavori['dimensions']
...
df_lavori['inscription'] = df_lavori['inscription']
df_lavori['thumbnailCopyright'] = df_lavori['thumbnailCopyright']
df_lavori['thumbnailUrl'] = df_lavori['thumbnailUrl']
df_lavori['url'] = df_lavori['url']
