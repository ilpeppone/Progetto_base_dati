...
$csv_file_artisti = "/home/peppe/Progetto_base_dati/artisti_puliti.csv"; // inseriamo il percorso del file CSV
// apriamo il file CSV degli artisti
if (($handle = fopen($csv_file_artisti, "r")) !== FALSE) {
    ...
    // chiudiamo il file CSV degli artisti
    fclose($handle);
} else {
